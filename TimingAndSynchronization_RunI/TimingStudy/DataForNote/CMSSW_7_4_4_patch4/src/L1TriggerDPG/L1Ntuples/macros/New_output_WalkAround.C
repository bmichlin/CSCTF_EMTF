...
class WalkAround : public L1Ntuple
{
	public :
		...
		void run(int FileNumber, int runNumber, Long64_t numEvents, int EventSelection, int stationInput, int ringInput, int numChambersInRing, int ME2Trigger, int ME3Trigger, int forwardOnly);
...
/*}}}*/
void WalkAround::run(int FileNumber, int runNumber, Long64_t numEvents, int EventSelection, int stationInput, int ringInput, int numChambersInRing, int ME2Trigger, int ME3Trigger, int forwardOnly) 
{

	////cout << "runNumber: " << runNumber << endl;	
	TFile *BAM = new TFile(Form("output_WalkAround_ME%d%d_%d_%d_Trig%d%d_File%d.root",stationInput,ringInput,runNumber,EventSelection,ME2Trigger,ME3Trigger, FileNumber),"RECREATE");
